...
const RemoveFromLibButton: FC<RemoveButtonProps> = ({ ugid }) => {
  ...
  const { mutateAsync, isPending } = UserGameQueries.useDeleteUserGame(
    userGuid!
  );
  ...
  const handleRemoveFromLib = async (
      ...
      {isPending ? (
        ...
        <>
          ...
          <div
            id="dropdown"
            className={`${
              visibleDropdown === ugid ? "absolute mt-8" : "hidden"
            ...
            >
              <li>
                <span
                  ...
                  className="block px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-red-800 dark:text-red-500"
                >
                  Remove From Library
                </span>
              </li>
