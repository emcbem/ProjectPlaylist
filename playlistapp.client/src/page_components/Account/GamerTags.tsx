                ...
                <>
                    {usersPlatforms.filter(x => x.platformId === 1).length > 0 && (
                        <div className="flex flex-row items-center mb-4">
                            <GamerTag platform={{ id: 1, name: 'Epic Games', logoURL: 'https://example.com/logoC.png' }} userPlatforms={usersPlatforms}>
                    ...
                    {usersPlatforms.filter(x => x.platformId === 130).length > 0 && (
                        <div className="flex flex-row items-center mb-4">
                            <GamerTag platform={{ id: 130, name: 'Nintendo', logoURL: 'https://example.com/logoC.png' }} userPlatforms={usersPlatforms}>
                    ...
                    {usersPlatforms.filter(x => x.platformId === 11).length > 0 && (
                        <div className="flex flex-row items-center mb-4">
                            <GamerTag platform={{ id: 11, name: 'Xbox', logoURL: 'https://example.com/logoB.png' }} userPlatforms={usersPlatforms}>
                    ...
                    {usersPlatforms.filter(x => x.platformId === 7).length > 0 && (
                        <div className="flex flex-row items-center mb-4">
                            <GamerTag platform={{ id: 7, name: 'PlayStation', logoURL: 'https://example.com/logoC.png' }} userPlatforms={usersPlatforms}>
                                <svg width={38}
                    ...
                    {usersPlatforms.filter(x => x.platformId === 136).length > 0 && (
                        <div className="flex flex-row items-center mb-4">
                            <GamerTag platform={{ id: 163, name: 'Steam', logoURL: 'https://example.com/logoA.png' }} userPlatforms={usersPlatforms}>
                                <svg width={34}
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="transition-colors duration-300 fill-current group-hover:fill-[#FFFFFF]"
                                    version="1.1"
