...
const SearchPage: React.FC = () => {
    ...
    // Update searchRequest when searchQuery changes
    useEffect(() => {
    ...
    // Automatically refetches data whenever searchRequest changes
    const { data, isLoading, refetch} =  GameQueries.useFilterGameQuery(searchRequest);
