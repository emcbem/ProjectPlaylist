...
const EditGamerTags = () => {
    ...
    // For documentation, here are the platforms
    // const platformList: Platform[] = [
    //     { id: 163, name: 'Steam', logoURL: 'https://example.com/logoA.png' },
    //     { id: 11, name: 'Xbox', logoURL: 'https://example.com/logoB.png' },
    //     { id: 7, name: 'PlayStation', logoURL: 'https://example.com/logoC.png' },
    //     { id: 130, name: 'Nintendo', logoURL: 'https://example.com/logoC.png' },
    //     { id: 1, name: 'Epic Games', logoURL: 'https://example.com/logoC.png' },
    // ];
    ...
    return (
        <div className="">
            <div className="flex flex-row items-center mb-8">
                <EditGamerTagField platform={{ id: 1, name: 'Epic Games', logoURL: 'https://example.com/logoC.png' }} userPlatforms={usersPlatforms} userGuid={userGuid}>
                    <EpicIconCustom width={'30'} />
                </EditGamerTagField>
            </div>
            <div className="flex flex-row items-center mb-8">
                <EditGamerTagField platform={{ id: 130, name: 'Nintendo', logoURL: 'https://example.com/logoC.png' }} userPlatforms={usersPlatforms} userGuid={userGuid}>
                    <SwitchIconCustom width={'30'} />
                </EditGamerTagField>
            </div>

            <div className="flex flex-row items-center mb-8">
                <EditGamerTagField platform={{ id: 11, name: 'Xbox', logoURL: 'https://example.com/logoB.png' }} userPlatforms={usersPlatforms} userGuid={userGuid}>
                    <XboxIconCustom width={'30'} />
                </EditGamerTagField>
            </div>

            <div className="flex flex-row items-center mb-8">
                <EditGamerTagField platform={{ id: 7, name: 'PlayStation', logoURL: 'https://example.com/logoC.png' }} userPlatforms={usersPlatforms} userGuid={userGuid}>
                    <svg width={38}
            ...
            <div className="flex flex-row items-center mb-8">
                <EditGamerTagField platform={{ id: 163, name: 'Steam', logoURL: 'https://example.com/logoA.png' }} userPlatforms={usersPlatforms} userGuid={userGuid}>
                    <svg width={34}
                        xmlns="http://www.w3.org/2000/svg"
                        className="transition-colors duration-300 fill-current group-hover:fill-[#FFFFFF]"
                        version="1.1"
