    ...
    <div className="min-h-screen bg-white dark:bg-black dark:text-white">
      <div className="grid justify-items-center ">
        <div style={{ maxWidth: '1200px' }} className='w-full mt-8'>
          <div className="text-lg mt-6 mb-6"><Link to={'/account'}><span className='hover:underline underline-offset-2'>Account</span></Link> <span className='text-clay-950  font-light'>/ {list?.name}</span></div>
          ...
          <div className="flex flex-row justify-left align-middle mt-4 mb-3">
            ...
            <p className="text-xl text-clay-950">{list?.games.length} {list?.games.length === 1 ? "Game" : "Games"}</p>
          </div>
