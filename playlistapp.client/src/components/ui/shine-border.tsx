...
export default function ShineBorder({
  ...
  return (
    <div
      className={cn(
        "relative min-h-[60px] w-fit min-w-[300px] bg-white p-3 text-black dark:bg-black dark:text-white rounded-xl",
        className
      )}
    >
      <div
