const UserAccountKeys = {
  ...
  GetUserByUserId: (userGuid: string) =>
    ["UserAccount", "GetuserById", userGuid] as const,
  ...
  GetUser: (userGuid: string) =>
    ["UserAccount", "GetUserByAuthId", userGuid] as const,
  GetUsersByQuery: (userGuid: string) =>
    ["UserAccount", "GetUserByAuthId", userGuid] as const,
  GetUsersBySearchQuery: (query: string) =>
    ["UserAccount", "GetUsersBySearchQuery", query] as const,
};
